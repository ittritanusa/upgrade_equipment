...
import { useCreateUnitKendaraan } from './Hooks/useCreateUnitKendaraan'; // 2. Import hook

export default function CreateUnitKendaraan() {
    const navigate = useNavigate();
    const mutation = useCreateUnitKendaraan(); // 3. Panggil hook mutasi
            ...
            if (result.isConfirmed) {
                ...
                mutation.mutate(formData, {
                    onSuccess: () => {
                        Swal.fire({
                            title: 'Berhasil!',
                            text: 'Data unit kendaraan telah disimpan.',
                            icon: 'success',
                            timer: 2000,
        ...
        <PortalLayout>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold text-slate-800">Tambah Unit Kendaraan</h1>
                ...
                <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-xl p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Kode Unit */}
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-2">Kode Unit *</label>
                            <input
                                type="text"
                                required
                                value={formData.Kode}
                        ...
                        {/* Nama Unit */}
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-2">Nama Unit *</label>
                            <input
                                type="text"
                                required
                                value={formData.Unit}
                    ...
                    <div className="flex items-center gap-3 mt-8 pt-6 border-t border-slate-200">
                        ...
                        <button
                            type="button"
                            onClick={() => navigate('/portal/master/unit-kendaraan')}
