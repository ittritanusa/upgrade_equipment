...
const DETAIL_AP = {
    ...
    dueDate: '2026-06-15',
    notes:
        'Pembayaran material proyek area STA 12+200 dan jasa sewa alat berat.',
...
// COMPONENT
// ==========================================
export default function EditAccountPayable() {

    const navigate = useNavigate();
    const { id } = useParams();

    const selectedVendor = MOCK_VENDOR.find(
        (vendor) => vendor.id === DETAIL_AP.vendorId
    );
    ...
    const [form, setForm] = useState({
        invoiceNumber: DETAIL_AP.invoiceNumber,
        vendorId: DETAIL_AP.vendorId,
        vendorName: selectedVendor?.nama || '',
        picVendor: selectedVendor?.pic || '',
        paymentTerm: selectedVendor?.paymentTerm || '',
        paymentMethod: selectedVendor?.metode || '',
        bankAccount: selectedVendor?.bank || '',
        invoiceDate: DETAIL_AP.invoiceDate,
        dueDate: DETAIL_AP.dueDate,
        notes: DETAIL_AP.notes,
    });

    // ==========================================
    // ITEMS
    // ==========================================
    const [items, setItems] = useState(DETAIL_AP.items);
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Edit informasi hutang vendor / supplier
                            </p>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    disabled
                                    className="w-full h-11 pl-10 pr-4 rounded-xl border border-gray-200 bg-gray-50 text-sm"
                                />
                    ...
                    <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Edit item barang atau jasa invoice
                                </p>
