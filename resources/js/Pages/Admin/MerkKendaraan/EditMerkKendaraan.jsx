...
import {
    useMerkKendaraanDetail,
    useUpdateMerkKendaraan,
} from './Hooks/useEditMerkKendaraan';

export default function EditMerkKendaraan() {
    ...
    const updateMutation = useUpdateMerkKendaraan();
    ...
    const { data, isLoading } = useMerkKendaraanDetail(realId);
